...
const publicScripts = new Set(['gallery.js','ui-motion.js','hero-motion.js','dossier.js','model-viewer.js','ba-model-materials.js','mika-halo.js','toon-renderer.js','spine-viewer.js']);
